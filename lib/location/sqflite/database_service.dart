...
class Location {
  ...
  Location({this.id, required this.placeName, required this.latitude, required this.longitude});
...
// import 'package:flutter_voice_recording_to_text_convert/location/sqflite/placeDetail.dart';
// import 'package:path/path.dart';
// import 'package:sqflite/sqflite.dart';
...
//     final path = join(databasePath, 'favorite_place_database.db');
...
//     final db = await _databaseService.database;
//     await db.update('place', dog.toMap(), where: 'id = ?', whereArgs: [dog.id]);
//   }
